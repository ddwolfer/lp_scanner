...
## 實盤驗收：三週靜態頭寸 KPI（2026-09 起，D56）。目前對象：TSLA/USDG v4 0.30% #2451233（2026-09-11 開，337.68–397.07，$1,056.92，position id 5）；AMD 因池被稀釋未開
每週固定一次，四個 KPI，全部唯讀：
1. **實收費 vs feeGrowth 重放**：`pnpm positions` 取實收；`pnpm replay TSLA --from=<mint block，見 positions.notes> --to=<latest> --lower=337.68 --upper=397.07`，看「feeGrowth 費」欄，誤差目標 ±10%。
